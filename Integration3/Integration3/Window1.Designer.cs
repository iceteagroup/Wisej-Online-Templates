namespace Integration3
{
    partial class Window1
    {
        ...
        private void InitializeComponent()
        {
			...
			this.tabPage2.Size = new System.Drawing.Size(984, 620);
			...
			this.widgetDonut.Size = new System.Drawing.Size(984, 620);
			...
			this.tabPage1.Size = new System.Drawing.Size(984, 620);
			...
			this.tableLayoutPanel2.Size = new System.Drawing.Size(984, 620);
			...
			this.flowLayoutPanel1.Size = new System.Drawing.Size(190, 614);
			...
			this.widgetPie.Size = new System.Drawing.Size(782, 614);
			...
			this.widgetPie.Packages.Add(package1);
			this.widgetPie.Packages.Add(package2);
			this.widgetPie.Packages.Add(package3);
			this.widgetPie.Packages.Add(package4);
			this.widgetPie.Packages.Add(package5);
			// 
			// tabPage3
			// 
			...
			this.tabPage3.Size = new System.Drawing.Size(984, 620);
			...
			this.tableLayoutPanel1.RowStyles.Add(new Wisej.Web.RowStyle(Wisej.Web.SizeType.Percent, 50F));
			this.tableLayoutPanel1.Size = new System.Drawing.Size(984, 620);
			...
			this.panel4.Location = new System.Drawing.Point(495, 313);
			this.panel4.Name = "panel4";
			this.panel4.ShowHeader = true;
			this.panel4.Size = new System.Drawing.Size(486, 304);
			...
			this.widgetQRfreeText.Size = new System.Drawing.Size(262, 188);
			this.widgetQRfreeText.TabIndex = 0;
			this.widgetQRfreeText.Text = "widget1";
			this.widgetQRfreeText.Packages.Add(package1);
			this.widgetQRfreeText.Packages.Add(package2);
			this.widgetQRfreeText.Packages.Add(package3);
			this.widgetQRfreeText.Packages.Add(package4);
			this.widgetQRfreeText.Packages.Add(package5);
			// 
			// panel3
			// 
			...
			this.panel3.Size = new System.Drawing.Size(486, 304);
			...
			this.widgetQRurl.Size = new System.Drawing.Size(263, 188);
			this.widgetQRurl.TabIndex = 0;
			this.widgetQRurl.Text = "widget1";
			this.widgetQRurl.Packages.Add(package1);
			this.widgetQRurl.Packages.Add(package2);
			this.widgetQRurl.Packages.Add(package3);
			this.widgetQRurl.Packages.Add(package4);
			this.widgetQRurl.Packages.Add(package5);
			// 
			// panel2
			// 
			...
			this.panel2.Size = new System.Drawing.Size(486, 304);
			...
			this.widgetQRgeo.Size = new System.Drawing.Size(262, 189);
			this.widgetQRgeo.TabIndex = 0;
			this.widgetQRgeo.Text = "widget1";
			this.widgetQRgeo.Packages.Add(package1);
			this.widgetQRgeo.Packages.Add(package2);
			this.widgetQRgeo.Packages.Add(package3);
			this.widgetQRgeo.Packages.Add(package4);
			this.widgetQRgeo.Packages.Add(package5);
			// 
			// panel1
			// 
			...
			this.panel1.Size = new System.Drawing.Size(486, 304);
			...
			this.widgetQRemail.Size = new System.Drawing.Size(263, 189);
			this.widgetQRemail.TabIndex = 0;
			this.widgetQRemail.Text = "widget1";
			this.widgetQRemail.Packages.Add(package1);
			this.widgetQRemail.Packages.Add(package2);
			this.widgetQRemail.Packages.Add(package3);
			this.widgetQRemail.Packages.Add(package4);
			this.widgetQRemail.Packages.Add(package5);
			// 
			// Window1
			// 
